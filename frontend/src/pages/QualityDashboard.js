              ...
              <CardContent className="space-y-4 pt-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, academic_performance_rate: e.target.value ? parseInt(e.target.value) : "" })}
                    required
                  />
                </div>
                <div>
              ...
              <CardContent className="space-y-4 pt-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, discipline_rate: e.target.value ? parseInt(e.target.value) : "" })}
                    required
                  />
                </div>
                <div>
              ...
              <CardContent className="space-y-4 pt-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, activities_quality_rate: e.target.value ? parseInt(e.target.value) : "" })}
                    required
                  />
                </div>
                <div>
              ...
              <CardContent className="space-y-4 pt-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, social_specialist_performance_rate: e.target.value ? parseInt(e.target.value) : "" })}
                    required
                  />
                </div>
                <div>
