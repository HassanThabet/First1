              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                    {/* Teachers Chart */}
                    {(reportTypeFilter === "all" || reportTypeFilter === "supervisor") && (
                      <div id="chairman-teachers-chart">
                    ...
                    {(reportTypeFilter === "all" || reportTypeFilter === "supervisor" || reportTypeFilter === "vice_principal") && (
                      <div id="chairman-absent-teachers-chart">
                  ...
                  <div className="space-y-4">
                    {selectedReport.late_teachers && selectedReport.late_teachers.length > 0 && (
                      <div className="p-4 bg-orange-50 rounded-lg">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                          {selectedReport.late_teachers.map((lt, idx) => (
                            <li key={`edu-late-${selectedReport.id}-${idx}-${typeof lt === 'object' ? lt.teacher : lt}`} className="text-sm">
                      ...
                      <div className="p-4 bg-red-50 rounded-lg">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                          {selectedReport.problems.map((problem, idx) => (
                            <li key={`problem-${selectedReport.id}-${idx}-${typeof problem === 'object' ? problem.description : problem}`} className="text-sm">
                      ...
                      <div className="p-4 bg-blue-50 rounded-lg">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                          {selectedReport.suggestions.map((suggestion, idx) => (
                            <li key={`suggestion-${selectedReport.id}-${idx}-${typeof suggestion === 'object' ? suggestion.description : suggestion}`} className="text-sm">
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      {teachersListData.teachers.map((teacher, index) => (
                        <tr key={`teacher-${teacher.name}-${index}`} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
