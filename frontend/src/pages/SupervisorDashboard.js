                ...
                <Card key={report.id} className="report-card overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white">
                    <CardTitle className="flex items-center justify-between">
                      <div>
                        <div className="text-xl font-bold">تقرير {new Date(report.date).toLocaleDateString("ar-SA", { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="stat-card bg-gradient-to-br from-cyan-50 to-cyan-100 border-l-4 border-cyan-500">
                          <div className="text-sm text-gray-700 mb-1 font-semibold">انضباط الطلاب</div>
                          <div className="text-3xl font-bold text-cyan-700">{report.student_discipline}/10</div>
                          {report.student_discipline_notes && (
                            <div className="text-xs text-gray-600 mt-1">{report.student_discipline_notes}</div>
                          )}
                        </div>
                        <div className="stat-card bg-gradient-to-br from-blue-50 to-blue-100 border-l-4 border-blue-500">
                          <div className="text-sm text-gray-700 mb-1 font-semibold">نظافة الفصول</div>
                          <div className="text-3xl font-bold text-blue-700">{report.classroom_cleanliness}/10</div>
                          {report.classroom_cleanliness_notes && (
                            <div className="text-xs text-gray-600 mt-1">{report.classroom_cleanliness_notes}</div>
                          )}
                        </div>
                        <div className="stat-card bg-gradient-to-br from-purple-50 to-purple-100 border-l-4 border-purple-500">
                          <div className="text-sm text-gray-700 mb-1 font-semibold">التزام المعلمين</div>
                          <div className="text-3xl font-bold text-purple-700">{report.teacher_attendance_rate}/10</div>
                          {report.teacher_attendance_notes && (
                            <div className="text-xs text-gray-600 mt-1">{report.teacher_attendance_notes}</div>
                          )}
                        </div>
                        <div className="stat-card bg-gradient-to-br from-green-50 to-green-100 border-l-4 border-green-500">
                          <div className="text-sm text-gray-700 mb-1 font-semibold">السلوك العام</div>
                          <div className="text-3xl font-bold text-green-700">{report.general_behavior}/10</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Teachers Info */}
                      {(report.late_teachers?.length > 0 || report.absent_teachers?.length > 0 || report.covering_teachers?.length > 0) && (
                        <div className="space-y-3">
                          <h4 className="text-md font-bold text-gray-800 mb-3 border-b-2 border-gray-200 pb-2">
                            بيانات المعلمين
                          </h4>
                          ...
                          {report.late_teachers && report.late_teachers.length > 0 && (
                            <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
                              <div className="text-sm font-bold text-orange-800 mb-2 flex items-center">
                                <span className="w-2 h-2 bg-orange-500 rounded-full ml-2"></span>
                                المعلمون المتأخرون ({report.late_teachers.length})
                              </div>
                              <ul className="text-sm text-gray-700 space-y-1">
                          ...
                          {report.absent_teachers && report.absent_teachers.length > 0 && (
                            <div className="p-3 bg-red-50 rounded-lg border border-red-200">
                              <div className="text-sm font-bold text-red-800 mb-2 flex items-center">
                                <span className="w-2 h-2 bg-red-500 rounded-full ml-2"></span>
                                المعلمون الغائبون ({report.absent_teachers.length})
                              </div>
                              <ul className="text-sm text-gray-700 space-y-1">
                          ...
                          {report.covering_teachers && report.covering_teachers.length > 0 && (
                            <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                              <div className="text-sm font-bold text-green-800 mb-2 flex items-center">
                                <span className="w-2 h-2 bg-green-500 rounded-full ml-2"></span>
                                المعلمون المغطون ({report.covering_teachers.length})
                              </div>
                              <ul className="text-sm text-gray-700 space-y-1">
                      ...
                      <div className="space-y-3">
                        ...
                        {report.incidents && report.incidents.length > 0 && (
                          <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                            <div className="text-sm font-bold text-yellow-800 mb-2 flex items-center">
                              <span className="w-2 h-2 bg-yellow-500 rounded-full ml-2"></span>
                              الحوادث والمخالفات ({report.incidents.length})
                            </div>
                            <div className="space-y-2">
                        ...
                        {report.student_movement_classes && report.student_movement_classes.length > 0 && (
                          <div className="p-3 bg-purple-50 rounded-lg border border-purple-200">
                            <div className="text-sm font-bold text-purple-800 mb-2">
                              الصفوف المتابعة للتنقل
                            </div>
                            <div className="flex flex-wrap gap-2">
                              {report.student_movement_classes.map((cls, i) => (
                                <span key={i} className="text-xs bg-purple-200 text-purple-800 px-2 py-1 rounded-full">
                                  {cls}
                                </span>
                              ))}
                            </div>
                            {report.student_movement_notes && (
                              <p className="text-xs text-gray-600 mt-2">{report.student_movement_notes}</p>
                            )}
                          </div>
                        )}
                        ...
                        {report.absent_students_count > 0 && (
                          <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <div className="text-2xl font-bold text-blue-600 mt-1">
                              {report.absent_students_count} طالب
                            </div>
                          </div>
                        )}
                        ...
                        {report.general_notes && (
                          <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <p className="text-sm text-gray-700 leading-relaxed">{report.general_notes}</p>
                          </div>
                        )}
                      </div>
                    </div>
