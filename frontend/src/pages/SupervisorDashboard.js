              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  {formData.late_teachers.map((lt, index) => (
                    <div key={`late-teacher-${index}-${lt.teacher}-${lt.subject}`} className="border border-gray-200 rounded-lg p-3 mb-3 bg-white">
                      ...
                      <div className="flex gap-2 items-center">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-md px-3 py-2">
                            <span className="text-sm font-semibold text-blue-700">الحصة:</span>
                            <Input
                              ...
                              max="10"
                              placeholder="رقم"
                              className="border-0 bg-transparent text-center font-bold text-2xl text-blue-900 focus:ring-0 p-0 h-auto w-16"
                              value={lt.period}
            ...
            <Card>
              ...
              <CardContent>
                {formData.covering_teachers.map((ct, index) => (
                  <div key={`covering-teacher-${index}-${ct.teacher}-${ct.subject}`} className="border border-gray-200 rounded-lg p-3 mb-3 bg-white">
                    <div className="flex gap-2 mb-2">
                      <Select 
                        value={ct.subject} 
                    ...
                    <div className="flex gap-2 items-center">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-md px-3 py-2">
                          <span className="text-sm font-semibold text-green-700">الحصة:</span>
                          <Input
                            ...
                            max="10"
                            placeholder="رقم"
                            className="border-0 bg-transparent text-center font-bold text-2xl text-green-900 focus:ring-0 p-0 h-auto w-16"
                            value={ct.period}
                            ...
                            <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
                              ...
                              <ul className="text-sm text-gray-700 space-y-1">
                                {selectedReport.late_teachers.map((lt, i) => (
                                  <li key={`late-${lt.teacher}-${lt.subject}-${lt.period}`} className="flex items-start">
                          ...
                          <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                            ...
                            <div className="space-y-2">
                              {selectedReport.incidents.map((inc, i) => (
                                <div key={`incident-${i}-${inc.description.substring(0, 20)}`} className="text-sm bg-white p-2 rounded">
